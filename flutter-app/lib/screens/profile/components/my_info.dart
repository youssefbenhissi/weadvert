...
class MyInfo extends StatelessWidget {
  ...
  String photo, nom, prenom, lieuCirculation;
  DateTime dateNaiss;

  MyInfo(
      this.photo, this.nom, this.prenom, this.dateNaiss, this.lieuCirculation);
        ...
        children: [
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                ", " + (DateTime.now().year - this.dateNaiss.year).toString(),
                style: TextStyle(
                  fontSize: 24.0,
                  color: Colors.white,
                  fontWeight: FontWeight.w600,
